...
public class UFileFileSystemTest {
    ...
    public static String Endpoint = "cn-bj.ufileos.com";
    public static String AccessKey = "TOKEN_xxxx-xxxx-xxxxx-xxxxx";
    public static String SecretKey = "xxxx-xxxx-xxxxx-xxxxx-xxxx";
    public static String LogLvl = "trace";
