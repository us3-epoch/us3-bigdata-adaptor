...
public class Configure {
    ...
    public void Parse(Configuration cfg) throws IOException {
        ...
        if (UseMDS) {
            ...
            if (MDSHost.isEmpty()) {
                throw new IOException("The us3 metadata server address is not specified");
            }
        }
        ...
        // 设置版本
        //UfileConstants.setSdkVersion(Constants.VERSION);
    }
    ...
    public String toString() {
        return "\n1. "+Constants.CS_US3_ACCESS_KEY+":"+PublicKey + "\n"+
              ...
              "12."+Constants.CS_US3_GENERATE_MD5+":"+generateMD5+"\n";
    }
}
